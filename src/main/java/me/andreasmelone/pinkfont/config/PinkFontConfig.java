...
public class PinkFontConfig {
    ...
    public static ConfigClassHandler<PinkFontConfig> HANDLER = ConfigClassHandler.createBuilder(PinkFontConfig.class)
            .id(PinkFontMod.rl("config"))
                    .serializer(config -> GsonConfigSerializerBuilder.create(config)
                            .setPath(Platform.getConfigDir().resolve(PinkFontMod.MOD_ID + ".json5"))
        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .option(Option.<ColorMode>createBuilder()
                                ...
                                .description(OptionDescription.createBuilder()
                                        .webpImage(PinkFontMod.webp("colormode_preview"))
                        ...
                        .group(colorListOption = ListOption.<Color>createBuilder()
                                ...
                                .description(OptionDescription.createBuilder()
                                        ...
                                        .build())
                                .initial(() -> {
                                    if(getInstance().colors.isEmpty()) return DEFAULT_COLORS.get(0);
                                    return getInstance().colors.get(getInstance().colors.size() - 1);
                                })
