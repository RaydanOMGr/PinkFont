...
public class PresetManager {
    ...
    private void load(ResourceManager resourceManager) {
        ...
        for (String namespace : resourceManager.getNamespaces()) {
            ...
            ResourceLocation location = ResourceLocation.fromNamespaceAndPath(namespace, presetLocation.getPath());
    ...
    private void loadFromResourceLocation(ResourceManager resourceManager, String namespace, ResourceLocation location) {
        ...
        PinkFontCommon.LOGGER.info("Loading presets from namespace {}", namespace);
        try(BufferedReader reader = presetResource.openAsReader()) {
            loadedPresets.putAll(GSON.fromJson(reader, type));
        } catch (IOException e) {
            PinkFontCommon.LOGGER.error("Failed to read presets in namespace {}! Not loading.", namespace, e);
        }
    }
